...
-- =====================================
-- Package: pkg_lecture_student - CRUD Operations 
-- =====================================

-- Test lecture-student relationship operations
declare
   v_lecture_id number := 1;
   v_student_id number := 1;
   v_rec        pkg_lecture_student.lecture_student_rec;
begin
   -- Add lecture-student relationship
   pkg_lecture_student.add_lecture_student(
      v_lecture_id,
      v_student_id
   );
   dbms_output.put_line('Lecture-student relationship added');
   
   -- Update relationship
   pkg_lecture_student.update_lecture_student(
      v_lecture_id,
      v_student_id,
      2,
      2
   );
   dbms_output.put_line('Lecture-student relationship updated');
   
   -- Get lectures by student
   declare
      v_lectures pkg_lecture_student.lecture_id_table;
   begin
      v_lectures := pkg_lecture_student.get_lectures_by_student(2);
      dbms_output.put_line('Lectures for student 2: ' || v_lectures.count);
   end;
   
   -- Get students by lecture
   declare
      v_students pkg_lecture_student.student_id_table;
   begin
      v_students := pkg_lecture_student.get_students_by_lecture(2);
      dbms_output.put_line('Students for lecture 2: ' || v_students.count);
   end;
   
   -- Delete relationship (cleanup)
   pkg_lecture_student.delete_lecture_student(
      2,
      2
   );
   dbms_output.put_line('Lecture-student relationship deleted');
end;
/

-- =====================================
-- Package: pkg_lecture_teacher - CRUD Operations
-- =====================================

-- Test lecture-teacher relationship operations
declare
   v_lecture_id number := 1;
   v_teacher_id number := 1;
   v_rec        pkg_lecture_teacher.lecture_teacher_rec;
begin
   -- Add lecture-teacher relationship
   pkg_lecture_teacher.add_lecture_teacher(
      v_lecture_id,
      v_teacher_id
   );
   dbms_output.put_line('Lecture-teacher relationship added');
   
   -- Update relationship
   pkg_lecture_teacher.update_lecture_teacher(
      v_lecture_id,
      v_teacher_id,
      2,
      2
   );
   dbms_output.put_line('Lecture-teacher relationship updated');
   
   -- Get lectures by teacher
   declare
      v_lectures pkg_lecture_teacher.lecture_id_table;
   begin
      v_lectures := pkg_lecture_teacher.get_lectures_by_teacher(2);
      dbms_output.put_line('Lectures for teacher 2: ' || v_lectures.count);
   end;
   
   -- Get teachers by lecture
   declare
      v_teachers pkg_lecture_teacher.teacher_id_table;
   begin
      v_teachers := pkg_lecture_teacher.get_teachers_by_lecture(2);
      dbms_output.put_line('Teachers for lecture 2: ' || v_teachers.count);
   end;
   
   -- Delete relationship (cleanup)
   pkg_lecture_teacher.delete_lecture_teacher(
      2,
      2
   );
   dbms_output.put_line('Lecture-teacher relationship deleted');
end;
/
...
-- =====================================
-- Package: pkg_class_group_student - CRUD Operations
-- =====================================

-- Test class group-student relationship operations
declare
   v_class_group_id number := 1;
   v_student_id     number := 1;
   v_rec            pkg_class_group_student.class_group_student_rec;
begin
   -- Add class group-student relationship
   pkg_class_group_student.add_class_group_student(
      v_class_group_id,
      v_student_id
   );
   dbms_output.put_line('Class group-student relationship added');
   
   -- Update relationship
   pkg_class_group_student.update_class_group_student(
      v_class_group_id,
      v_student_id,
      2,
      2
   );
   dbms_output.put_line('Class group-student relationship updated');
   
   -- Get class group ID by natural key
   declare
      v_natural_key_id number;
   begin
      v_natural_key_id := pkg_class_group_student.get_class_group_id_by_natural_key(
         1,
         'Test Group'
      );
      if v_natural_key_id is not null then
         dbms_output.put_line('Class group found by natural key: ' || v_natural_key_id);
      end if;
   end;
   ...
   begin
      v_group_name := pkg_class_group_student.get_class_group_name_by_id(2);
      if v_group_name is not null then
         dbms_output.put_line('Class group name: ' || v_group_name);
      end if;
   end;
   
   -- Delete relationship (cleanup)
   pkg_class_group_student.delete_class_group_student(
      2,
      2
   );
   dbms_output.put_line('Class group-student relationship deleted');
end;
/
...
declare
   v_grade_group_id number := 1;
   v_student_id     number := 1;
   v_rec            pkg_grade_group_student.grade_group_student_rec;
begin
   -- Add grade group-student relationship
   pkg_grade_group_student.add_grade_group_student(
      v_grade_group_id,
      v_student_id,
      85,
      'Good work!',
   ...
   dbms_output.put_line('Grade group-student relationship added with grade 85');
   
   -- Update relationship
   pkg_grade_group_student.update_grade_group_student(
      v_grade_group_id,
      v_student_id,
      2,
      2,
   ...
   dbms_output.put_line('Grade group-student relationship updated');
   
   -- Get grade groups by student
   declare
      v_groups pkg_grade_group_student.grade_group_id_table;
   begin
      v_groups := pkg_grade_group_student.get_grade_groups_by_student(2);
      dbms_output.put_line('Grade groups for student 2: ' || v_groups.count);
   end;
   
   -- Get students by grade group
   declare
      v_students pkg_grade_group_student.student_id_table;
   begin
      v_students := pkg_grade_group_student.get_students_by_grade_group(2);
      dbms_output.put_line('Students for grade group 2: ' || v_students.count);
   end;
   
   -- Delete relationship (cleanup)
   pkg_grade_group_student.delete_grade_group_student(
      2,
      2
   );
