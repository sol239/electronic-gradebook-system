...
drop index idx_student_subject_teacher_student_id;
drop index idx_student_subject_teacher_subject_id;
drop index idx_student_subject_teacher_teacher_id;
...
drop package pkg_student_subject_teacher;
...
drop table student_subject_teacher cascade constraints;
...
begin
   dbms_output.put_line('Schema deletion completed.');
end;
/